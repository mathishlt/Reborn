            ...
            <div class="wrap_produit">
                <div class="produits">
                    <div class="titre_description_produit">
                        <h2 class="titre_du_produit"><?php the_field('titre_du_produit'); ?></h2>
                        <p class="description_du_produit"><?php the_field('description_courte_du_produit') ?></p>
                    </div>
                    <div class="image_produit">
                        <div class="cerle_produit">
                            <?php
                            $image_produit = get_field('image_du_produit');
