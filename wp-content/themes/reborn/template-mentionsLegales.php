...
get_header(); ?>
    ...
    <div class="wrap_cgu_ml">
        <h2 class="titre_principal_cgu_ml">Informations légales</h2>
        <h3 class="titre_secondaire_cgu_ml">1. Présentation du site.</h3>
        <p>En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans l'économie numérique, il
            est précisé aux utilisateurs du site <a class="liens_reborn_cgu_ml" href="http://www.reborn-france.com/">www.reborn-france.com</a>
            l'identité des différents intervenants dans le cadre de sa réalisation et de son suivi :</p>
        <p><strong>Propriétaire</strong> : Reborn – SAS – 6 rue Verdier Monetti 76880 Arques-la-Bataille<br/>
            <strong>Créateur</strong> : Houlet Mathis & Pillebout Janssen<br/>
            ...
            Crédits : Janssen Pillebout - Designer, développeur
            Houlet Mathis - Photographe, développeur<br/>
        ...
        <h3 class="titre_secondaire_cgu_ml">2. Conditions générales d’utilisation du site et des services proposés.</h3>
        <p>L’utilisation du site <a class="liens_reborn_cgu_ml" href="http://www.reborn-france.com/">www.reborn-france.com</a>
            ...
            site <a class="liens_reborn_cgu_ml" href="http://www.reborn-france.com/">www.reborn-france.com</a> sont donc
        ...
        <p>Ce site est normalement accessible à tout moment aux utilisateurs. Une interruption pour raison de
            maintenance technique peut être toutefois décidée par Reborn, qui s’efforcera alors de communiquer
            préalablement aux utilisateurs les dates et heures de l’intervention.</p>
        <p>Le site <a class="liens_reborn_cgu_ml" href="http://www.reborn-france.com/">www.reborn-france.com</a> est mis
            à jour régulièrement par Dubuc Baptiste. De la même façon, les mentions légales peuvent être modifiées à
            tout moment : elles s’imposent néanmoins à l’utilisateur qui est invité à s’y référer le plus souvent
            possible afin d’en prendre connaissance.</p>
        <h3 class="titre_secondaire_cgu_ml">3. Description des services fournis.</h3>
        <p>Le site <a class="liens_reborn_cgu_ml" href="http://www.reborn-france.com/">www.reborn-france.com</a> a pour
            objet de fournir une information concernant l’ensemble des activités de la société.</p>
        <p>Reborn s’efforce de fournir sur le site <a class="liens_reborn_cgu_ml" href="http://www.reborn-france.com/">www.reborn-france.com</a>
        ...
        <p>Tous les informations indiquées sur le site <a class="liens_reborn_cgu_ml"
                                                          href="http://www.reborn-france.com/">www.reborn-france.com</a>
            sont données à titre indicatif, et sont susceptibles d’évoluer. Par ailleurs, les renseignements figurant
            sur le site <a class="liens_reborn_cgu_ml" href="http://www.reborn-france.com/">www.reborn-france.com</a> ne
            sont pas exhaustifs. Ils sont donnés sous réserve de modifications ayant été apportées depuis leur mise en
            ligne.</p>
        <h3 class="titre_secondaire_cgu_ml">4. Limitations contractuelles sur les données techniques.</h3>
        <p>Le site utilise le CMS Wordpress.</p>
        ...
        <h3 class="titre_secondaire_cgu_ml">5. Propriété intellectuelle et contrefaçons.</h3>
        <p>Reborn est propriétaire des droits de propriété intellectuelle ou détient les droits d’usage sur tous les
        ...
        <h3 class="titre_secondaire_cgu_ml">6. Limitations de responsabilité.</h3>
        <p>Reborn ne pourra être tenue responsable des dommages directs et indirects causés au matériel de
            l’utilisateur, lors de l’accès au site www.reborn-france.com, et résultant soit de l’utilisation d’un
            matériel ne répondant pas aux spécifications indiquées au point 4, soit de l’apparition d’un bug ou d’une
            incompatibilité.</p>
        <p>Reborn ne pourra également être tenue responsable des dommages indirects (tels par exemple qu’une perte de
            marché ou perte d’une chance) consécutifs à l’utilisation du site <a class="liens_reborn_cgu_ml"
                                                                                 href="http://www.reborn-france.com/">www.reborn-france.com</a>.
        </p>
        <p>Des espaces interactifs (possibilité de poser des questions dans l’espace contact) sont à la disposition des
            utilisateurs. Reborn se réserve le droit de supprimer, sans mise en demeure préalable, tout contenu déposé
            dans cet espace qui contreviendrait à la législation applicable en France, en particulier aux dispositions
            relatives à la protection des données. Le cas échéant, Reborn se réserve également la possibilité de mettre
            ...
            photographie…).</p>
        <h3 class="titre_secondaire_cgu_ml">7. Gestion des données personnelles.</h3>
        <p>En France, les données personnelles sont notamment protégées par la loi n° 78-87 du 6 janvier 1978, la loi n°
            ...
            1995.</p>
        <p>A l'occasion de l'utilisation du site <a class="liens_reborn_cgu_ml" href="http://www.reborn-france.com/">www.reborn-france.com</a>,
            peuvent êtres recueillies : l'URL des liens par l'intermédiaire desquels l'utilisateur a accédé au site <a
                    class="liens_reborn_cgu_ml" href="http://www.reborn-france.com/">www.reborn-france.com</a>, le
            fournisseur d'accès de l'utilisateur, l'adresse de protocole Internet (IP) de l'utilisateur.</p>
        <p> En tout état de cause Reborn ne collecte des informations personnelles relatives à l'utilisateur que pour le
            besoin de certains services proposés par le site <a class="liens_reborn_cgu_ml"
                                                                href="http://www.reborn-france.com/">www.reborn-france.com</a>.
            L'utilisateur fournit ces informations en toute connaissance de cause, notamment lorsqu'il procède par
            lui-même à leur saisie. Il est alors précisé à l'utilisateur du site <a class="liens_reborn_cgu_ml"
                                                                                    href="http://www.reborn-france.com/">www.reborn-france.com</a>
        ...
        <p>Aucune information personnelle de l'utilisateur du site <a class="liens_reborn_cgu_ml"
                                                                      href="http://www.reborn-france.com/">www.reborn-france.com</a>
            n'est publiée à l'insu de l'utilisateur, échangée, transférée, cédée ou vendue sur un support quelconque à
            des tiers. Seule l'hypothèse du rachat de Reborn et de ses droits permettrait la transmission des dites
            informations à l'éventuel acquéreur qui serait à son tour tenu de la même obligation de conservation et de
            modification des données vis à vis de l'utilisateur du site <a class="liens_reborn_cgu_ml"
                                                                           href="http://www.reborn-france.com/">www.reborn-france.com</a>.
        </p>
        ...
        <h3 class="titre_secondaire_cgu_ml">8. Liens hypertextes et cookies.</h3>
        <p>Le site <a class="liens_reborn_cgu_ml" href="http://www.reborn-france.com/">www.reborn-france.com</a>
            contient un certain nombre de liens hypertextes vers d’autres sites, mis en place avec l’autorisation de
            Reborn. Cependant, Reborn n’a pas la possibilité de vérifier le contenu des sites ainsi visités, et
            n’assumera en conséquence aucune responsabilité de ce fait.</p>
        <p>La navigation sur le site <a class="liens_reborn_cgu_ml" href="http://www.reborn-france.com/">www.reborn-france.com</a>
        ...
        <h3 class="titre_secondaire_cgu_ml">9. Droit applicable et attribution de juridiction.</h3>
        <p>Tout litige en relation avec l’utilisation du site <a class="liens_reborn_cgu_ml"
                                                                 href="http://www.reborn-france.com/">www.reborn-france.com</a>
            est soumis au droit français. Il est fait attribution exclusive de juridiction aux tribunaux compétents de
            Paris.</p>
        <h3 class="titre_secondaire_cgu_ml">10. Les principales lois concernées.</h3>
        ...
        <h3 class="titre_secondaire_cgu_ml">11. Lexique.</h3>
        ...
        <p>Mentions légales réalisées par le site <a href="http://www.subdelirium.com/ ">Subdelirium</a></p>
